...
from utils.generators import filter_by_currency, transaction_descriptions, card_number_generator
...
@pytest.mark.parametrize("currency_code, expected_transactions", [
    ("USD", [{
            "id": 939719570,
            "state": "EXECUTED",
            "date": "2018-06-30T02:08:58.425572",
